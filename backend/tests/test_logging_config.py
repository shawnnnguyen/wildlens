...
def test_configure_logging_is_a_noop_under_pytest():
    ...
    backend.api.main / wildlens's __main__.py would replace the root
    logger's handlers process-wide, silently breaking caplog-based
    assertions in every test collected afterward.
    """
