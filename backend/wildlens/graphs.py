...
from .state import WildlensState
from .nodes import (
    node_analyze_image,
...
from .nodes.analyze_image.router import route_after_analysis
from .nodes.check_relevance.router import route_after_relevance
from .nodes.generate_audio.router import route_audio


# ── Routing functions ─────────────────────────────────────────────────────────
# route_after_analysis, route_after_relevance, and route_audio each live
# alongside the node they gate (see wildlens/nodes/<name>/router.py) and are
# imported above. route_entry stays here — it's top-of-graph orchestration
# (photo vs. text turn), not tied to a single node.
